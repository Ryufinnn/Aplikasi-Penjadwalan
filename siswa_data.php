...
<table width="700" border="0" cellpadding="2" cellspacing="0" class='table table-bordered table-striped'>
	...
	<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
	  <table width="450" border="0" cellpadding="2" cellspacing="1" class='table table-bordered table-striped'>
	<tr>
	  <td colspan="3" bgcolor="#F5F5F5"><strong>PENCARIAN</strong></td>
	</tr>
	<tr>
	  <td width="169"><strong>Pencarian (NIS / Nama ) </strong></td>
	  <td width="5"><b>:</b></td>
    ...
    <tr>
      <td colspan="2"><a href="media.php?module=Siswa-Add" target="_self" class="btn btn-primary" >Tambah Data</a></td>
    </tr>
