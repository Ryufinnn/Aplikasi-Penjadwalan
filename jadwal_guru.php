...
<table width="100%" border="0" cellpadding="2" cellspacing="0"  class='table table-bordered table-striped'>
  <tr>
    <td colspan="2" align="right"><h5><b>Jadwal Mengajar</b></h5></td>
  </tr>
  ...
  <tr>
    <td colspan="2"><table class='table table-bordered table-striped' width="100%" border="0" cellspacing="1" cellpadding="2">
      ...
      <?php
	$mySql = "SELECT * FROM jadwal_guru where nama_guru='$_SESSION[namalengkap]' ORDER BY id_h  ASC ";
...
<a  href='javascript:print()'><button class='btn btn-warning'>Cetak</button></a>  
