...
<?php
$sql = mysql_query("select * from rb_login where level='admin' ");
$no=1;
...
echo "Halaman : ";
		...
		$sqlhal = mysql_query("select * from rb_login where level='admin'" );
		$sqldat = mysql_query("select * from rb_login where level='admin'");
